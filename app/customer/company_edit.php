...
<?php
	...
	if(postRequest('updatePassword')){
		updateCompanyPassword($_POST['companyid'], $_POST['password'] , $_POST['new_password']);
	}
						...
						<form method="post">
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<small>Input password to apply changes.</small>
								</div>
					...
					<section class="col-md-6">
						...
						<form method="post">
							...
							<div class="form-group">
								...
								<small>Username is not changeable</small>
							</div>
